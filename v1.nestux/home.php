...
// --- PHP ---
$LANG = [];
if (file_exists("{$TO_HOME}/v1.nestux/lang.{$APP_LANG}.php"))
  require_once "{$TO_HOME}/v1.nestux/lang.{$APP_LANG}.php";
// Language fallbacks if lang is supported but file doesn't exist
$preferred_lang = substr($_SERVER["HTTP_ACCEPT_LANGUAGE"] ?? "es", 0, 2);
if (!$LANG && file_exists("{$TO_HOME}/v1.nestux/lang.{$preferred_lang}.php"))
  require_once "{$TO_HOME}/v1.nestux/lang.{$preferred_lang}.php";
if (!$LANG && file_exists("{$TO_HOME}/v1.nestux/lang.en.php"))
  require_once "{$TO_HOME}/v1.nestux/lang.en.php";
?>
