    ...
    <div class="collapse navbar-collapse" id="navMenu">
        <ul class="navbar-nav">
            <small style="margin: 12px 0;">
                <a href="<?= "{$ROUTE_ROOT}{$ROUTE_NESTUX}/{$ROUTE_ES}"; ?>" class="a-lang" title="Español"><img src="<?= $HOME_PATH; ?>/img/co.png" /> ESP</a>
                <a href="<?= "{$ROUTE_ROOT}{$ROUTE_NESTUX}/{$ROUTE_EN}"; ?>" class="a-lang" title="English"><img src="<?= $HOME_PATH; ?>/img/uk.png" /> ENG</a>
            </small>
