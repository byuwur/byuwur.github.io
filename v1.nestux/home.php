  ...
  <div class="collapse navbar-collapse" id="navMenu">
    <ul class="navbar-nav">
      <small style="margin: 12px 0;">
        <a href="<?= $ROOT_ROUTE; ?>nestux/es" class="a-lang" title="Español"><img src="<?= $HOME_PATH; ?>/img/co.png" /> ESP</a>
        <a href="<?= $ROOT_ROUTE; ?>nestux/en" class="a-lang" title="English"><img src="<?= $HOME_PATH; ?>/img/uk.png" /> ENG</a>
      </small>
