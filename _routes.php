...
$routes = [
  ...
  // files
  "/{$ROUTE_RESUME}" => ["FILE" => "/Andres-Trujillo-Mateus-Resume.ES.pdf"],
  "/{$ROUTE_RESUME}.{$ROUTE_ES}" => ["FILE" => "/Andres-Trujillo-Mateus-Resume.ES.pdf"],
  "/{$ROUTE_RESUME}.{$ROUTE_EN}" => ["FILE" => "/Andres-Trujillo-Mateus-Resume.EN.pdf"],
  // "v1"
