<style>
    ...
    *:after {
    ...
    .view-pages .language .nav-tabs li {
        margin-top: -1px
    }

    .view-pages .language .nav-tabs li a {
        color: #FFF
    }

    .view-pages .language .nav-tabs li a:hover {
        color: #2e86de
    }

    .view-pages .language .nav-tabs li.active a {
        color: #2e86de
    }
...
<h2>How mnm.team uses cookies</h2>
...
<ul>
    ...
    <li>
        <p>For the Internet Explorer web browser, please visit this page from Microsoft: <a href="https://support.microsoft.com/kb/278835">https://support.microsoft.com/kb/278835</a></p>
    </li>
    <li>
...
<ul>
    <li>
        <p>AllAboutCookies: <a href="https://www.allaboutcookies.org/">https://www.allaboutcookies.org/</a></p>
    </li>
    <li>
        <p>Network Advertising Initiative: <a href="https://www.networkadvertising.org/">https://www.networkadvertising.org/</a></p>
    </li>
</ul>