		...
		var v,
			...
			y = (function () {
				...
				return (
					...
					(e.prototype._noticeScriptIfValid = function (e) {
						...
						!0 === t.searchObjectsArray(this.cookieConsent.cookieLevels.cookieLevels, "id", n)
							? (this.cookieConsent.log("Javascript with valid cookie consent found", "info"), this.cookieConsent.log(e, "info"), void 0 === this.scripts[n] && (this.scripts[n] = []), this.scripts[n].push(e))
							: this.cookieConsent.log("Invalid cookie consent level for javascript sript: " + n, "warning");
					}),
			...
			w = (function () {
				...
				return (
					(e.prototype.checkIfUserAccepted = function () {
						"true" === t.get_cookie(this.consentAcceptedCookieName) && (this.userAccepted = !0);
					}),
					(e.prototype.markUserAccepted = function () {
						(this.userAccepted = !0), !1 === this.cookieConsent.isDemo && t.set_cookie(this.consentAcceptedCookieName, "true");
					}),
					...
					(e.prototype.saveCookie = function () {
						...
						return t.set_cookie(this.consentLevelCookieName, e), this.cookieConsent.log("Saved cookies containing the user consent level", "info"), !0;
					}),
					e
				);
			})(),
			...
			j = (function () {
				...
				return (
					...
					(e.prototype.obtainLanguageSelector = function () {
						...
						return (
							[].forEach.call(e.cookieConsent.i18n.availableLanguages, function (o) {
					...
					(e.prototype.getMenuContainer = function () {
						...
						return (
							e.cookieConsent.cookieLevels.preferenceItems.forEach(function (i) {
								...
								a.setAttribute("href", "#"),
									a.setAttribute("t", i.content_container),
									(a.innerHTML = i.title),
									0 === o && r.setAttribute("active", "true"),
									o++,
					...
					(e.prototype.getFooterContainer = function () {
						...
						var o = document.createElement("div");
						o.classList.add("cc_cp_f_powered_by"), (o.innerHTML = t.magicTransform(""));
						var i = document.createElement("div");
						i.classList.add("cc_cp_f_save");
						var r = document.createElement("button");
						return (
							(r.innerHTML = e.cookieConsent.i18n.$t("preference_center", "save")),
					...
					(e.prototype._getLevelCheckbox = function (e) {
						...
						if ("strictly-necessary" !== e.id) {
							...
							r.setAttribute("cookie_consent_toggler", "true"),
								...
								r.setAttribute("class", "checkbox_cookie_consent"),
								r.setAttribute("id", e.id),
								r.setAttribute("name", e.id),
								(a = document.createElement("label")).setAttribute("for", e.id),
								i[e.id] ? (r.setAttribute("checked", "checked"), a.setAttribute("class", "is-active"), (a.innerHTML = n.cookieConsent.i18n.$t("dialog", "active"))) : (a.setAttribute("class", "is-inactive"), (a.innerHTML = n.cookieConsent.i18n.$t("dialog", "inactive"))),
								r.addEventListener("change", function () {
									...
									n.cookieConsent.log("User changed toggle for cookie level [" + t + "], new status: " + o, "info"),
										...
										!0 === o ? (n.cookieConsent.userConsent.acceptLevel(t), (i.innerHTML = n.cookieConsent.i18n.$t("dialog", "active"))) : (n.cookieConsent.userConsent.rejectLevel(t), (i.innerHTML = n.cookieConsent.i18n.$t("dialog", "inactive")));
								}),
								t.appendChild(o, r),
								t.appendChild(o, a);
						} else {
							...
							c.setAttribute("cookie_consent_toggler", "true"),
								...
								c.setAttribute("class", "checkbox_cookie_consent"),
								c.setAttribute("id", e.id),
								c.setAttribute("name", e.id),
								(a = document.createElement("label")).setAttribute("for", e.id),
								(a.innerHTML = n.cookieConsent.i18n.$t("dialog", "always_active")),
								t.appendChild(o, c),
								t.appendChild(o, a);
						}
						return o;
				...
				return (
					...
					(e.prototype.createDialogContent = function () {
						...
						a.classList.add("cc_b_ok"),
							"express" == e.cookieConsent.userConsentType ? (a.innerHTML = e.cookieConsent.i18n.$t("dialog", "i_agree_text")) : (a.innerHTML = e.cookieConsent.i18n.$t("dialog", "ok_text")),
						...
						c.classList.add("cc_b_cp"),
							...
							(c.innerHTML = e.cookieConsent.i18n.$t("dialog", "change_settings")),
			...
			E = (function (e) {
				function n(n) {
					...
					return o.dialogExtraCss.push("simple"), o.dialogExtraCss.push("px-3"), o.dialogExtraCss.push("py-3"), o;
				}
				return b(n, e), n;
			})(L),
			S = (function (e) {
				function n(n) {
					var o = e.call(this, n) || this;
					return o.dialogExtraCss.push("headline"), o.dialogExtraCss.push("px-3"), o.dialogExtraCss.push("py-3"), o;
				}
				return b(n, e), n;
			})(L),
			A = (function (e) {
				function n(n) {
					var o = e.call(this, n) || this;
					return o.dialogExtraCss.push("interstitial"), o.dialogExtraCss.push("px-3"), o.dialogExtraCss.push("py-3"), o;
				}
				return b(n, e), n;
			})(L),
			P = (function (e) {
				function n(n) {
					var o = e.call(this, n) || this;
					return o.dialogExtraCss.push("standalone"), o.dialogExtraCss.push("px-3"), o.dialogExtraCss.push("py-3"), o;
				}
				return b(n, e), n;
			})(L),
			I = (function () {
