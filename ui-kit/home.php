  ...
  <div class="page-content">
        ...
        <div class="example col-md-10 ml-auto mr-auto">
          <div class="row">
            <div class="color-wrapper col-lg-3 col-md-6 col-sm-6">
              <div class="color">
                <div class="swatch" style="background: #40B758"></div>
                <span class="title">Land Color</span>
                <span class="hex-value">#40B758</span>
              </div>
            </div>
            <div class="color-wrapper col-lg-3 col-md-6 col-sm-6">
              <div class="color">
                <div class="swatch" style="background: #0B7CBA"></div>
                <span class="title">House Color</span>
                <span class="hex-value">#0B7CBA</span>
              </div>
            </div>
            <div class="color-wrapper col-lg-3 col-md-6 col-sm-6">
              <div class="color">
                <div class="swatch" style="background: #E3A539"></div>
                <span class="title">Marketing Color</span>
                <span class="hex-value">#E3A539</span>
              </div>
            </div>
            <div class="color-wrapper col-lg-3 col-md-6 col-sm-6">
              <div class="color">
                <div class="swatch" style="background: #9B109B"></div>
                <span class="title">Notes Color</span>
                <span class="hex-value">#9B109B</span>
              </div>
            </div>
            <div class="color-wrapper col-lg-3 col-md-6 col-sm-6">
              <div class="color">
                <div class="swatch" style="background: #550000"></div>
                <span class="title">byUwUr Primary Color</span>
                <span class="hex-value">#550000</span>
              </div>
            </div>
            <div class="color-wrapper col-lg-3 col-md-6 col-sm-6">
              <div class="color">
                <div class="swatch" style="background: #000000"></div>
                <span class="title">byUwUr Secondary Color</span>
            ...
            <div class="color-wrapper col-lg-3 col-md-6 col-sm-6">
              <div class="color">
                ...
                <span class="title">byUwUr Third Color</span>
            ...
            <div class="color-wrapper col-lg-3 col-md-6 col-sm-6">
              <div class="color">
                ...
                <span class="title">byUwUr Fourth Color</span>
                <span class="hex-value">#999999</span>
              </div>
            </div>
            <div class="color-wrapper col-lg-3 col-md-6 col-sm-6">
              <div class="color">
              ...
              <form>
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="form1-name" autocomplete="username" placeholder="Name">
                  </div>
                  <div class="form-group col-md-6">
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    ...
                    <input type="password" class="form-control" id="form1-password" autocomplete="new-password" placeholder="Password" required>
                  </div>
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <div class="input-group input-group-seamless">
                      ...
                      <input type="text" class="form-control" id="form1-username" autocomplete="username" placeholder="Username">
                    </div>
                  </div>
                  <div class="form-group col-md-6">
                    <div class="input-group input-group-seamless">
                      <input type="password" class="form-control" id="form2-password" autocomplete="new-password" placeholder="Password">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" id="form2-username" autocomplete="username" placeholder="Username">
                    </div>
                  </div>
                  <div class="form-group col-md-6">
                    <div class="input-group">
                      <input type="password" class="form-control" id="form3-password" autocomplete="new-password" placeholder="Password">
                      <span class="input-group-append">
                        <span class="input-group-text">
                          <i class="fa fa-lock"></i>
                        </span>
              ...
              <div class="custom-controls-example col-md-2 col-sm-2 col-xs-12 pl-3">
                ...
                <fieldset disabled>
                  <div class="custom-control custom-toggle custom-toggle-sm d-block my-2">
                    ...
                    <label class="custom-control-label" for="customToggle4sm">Ultron</label>
                  </div>
                </fieldset>
              </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  Triggering this might break everything later.<br>
    ...
    <div id="navbars" class="my-5">
      ...
      <div class="example">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
          ...
          <a class="navbar-brand" href="javascript:;">byUwUr</a>
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="javascript:;">Design</a>
                  <a class="dropdown-item" href="javascript:;">Development</a>
                  <a class="dropdown-item" href="javascript:;">Marketing</a>
                </div>
              </li>
            </ul>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary mb-4">
          ...
          <div class="collapse navbar-collapse mr-auto" id="navbarNavDropdown-2">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="javascript:;" id="navbarDropdownMenuLink-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Services
                </a>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-success mb-4">
          ...
          <div class="collapse navbar-collapse mr-auto" id="navbarNavDropdown-3">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="javascript:;" id="navbarDropdownMenuLink-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Services
                </a>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-warning mb-4">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown-4">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="javascript:;" id="navbarDropdownMenuLink-4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Services
                </a>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-danger mb-4">
          ...
          <div class="collapse navbar-collapse mr-auto" id="navbarNavDropdown-5">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="javascript:;" id="navbarDropdownMenuLink-5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Services
                </a>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
          ...
          <div class="collapse navbar-collapse mr-auto" id="navbarNavDropdown-6">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="javascript:;" id="navbarDropdownMenuLink-6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Services
                </a>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown-7">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="javascript:;" id="navbarDropdownMenuLink-7" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Services
                </a>
    ...
    <div id="documentation" class="bg-white">
      <div class="section-title container ml-auto mr-auto py-5">
        <div class="col-lg-8 col-md-10 ml-auto mr-auto py-5">
          ...
          <p class="text-center">Make sure you check out the documentation and learn more about all the available components and how to use them from the kit this one is based on.</p>
          <a class="d-table ml-auto mr-auto" href="https://designrevision.com/docs/shards" target="_blank">
    ...
    <footer class="main-footer py-5">
      ...
      <div class="social d-table mx-auto">
        <a class="github mx-3 h4 d-inline-block text-secondary" href="https://github.com/byuwur" target="_blank">
          <i class="fab fa-github"></i>
        </a>
        <a class="linkedin mx-3 h4 d-inline-block text-secondary" href="https://linkedin.com/in/atrujillomateus" target="_blank">
          <i class="fab fa-linkedin"></i>
        </a>
        <a class="youtube mx-3 h4 d-inline-block text-secondary" href="https://youtube.com/byuwur" target="_blank">
          <i class="fab fa-youtube"></i>
        </a>
        <a class="facebook mx-3 h4 d-inline-block text-secondary" href="https://facebook.com/byuwur" target="_blank">
          <i class="fab fa-facebook"></i>
        </a>
        <a class="twitter mx-3 h4 d-inline-block text-secondary" href="https://twitter.com/byuwur" target="_blank">
          <i class="fab fa-twitter"></i>
        </a>
      </div>
    </footer>
