...
$_footer = "&copy;" . date("Y") . " Andrés Trujillo [Mateus] byUwUr<br><a href='/v1'>cargar HTML básico</a> | <a href='/mnm.team/cookies' target='_blank'>cookie policy</a> | <a href='/mnm.team'>MNM.team</a><br>Hecho con<i class='fas fa-heart'></i>por <a href='https://byuwur.co' target='_blank'>[Mateus] byUwUr</a>";
$_back = "Volver";
$_ok = "Entendido";
$_close = "Cerrar";
$_langs = "Idiomas";
