...
$_goto = "<a class='a-lang' href='{$ROUTE_ROOT}{$ROUTE_MNM}' custom-folder='true'>Ver más en MNM<small>.team();</small></a>";
$_name_top = "[Mateus] <span class='text-primary'>byUwUr</span>";
$_nombre = "Andrés Trujillo Mateus";
$_new = "cargar HTML no tan básico";
$_load = "<b>Cargando vista estándar...</b><br>¿Sigue cargando? <a href='{$ROUTE_ROOT}{$ROUTE_V1}' style='color:#0ae;'>Ir a la vista básica</a>";
$_footer = "&copy;" . date("Y") . " Andrés Trujillo [Mateus] byUwUr<br><a href='{$ROUTE_ROOT}{$ROUTE_V1}'>cargar HTML básico</a> | <a href='{$ROUTE_ROOT}{$ROUTE_MNM}/{$ROUTE_COOKIES}' target='_blank'>cookie policy</a> | <a href='{$ROUTE_ROOT}{$ROUTE_MNM}'>MNM.team</a><br>Hecho con<i class='fas fa-heart'></i>por <a href='https://byuwur.co' target='_blank'>[Mateus] byUwUr</a>";
$_back = "Volver";
$_ok = "Entendido";
$_close = "Cerrar";
$_langs = "Idiomas";
