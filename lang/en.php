...
$_goto = "<a class='a-lang' href='/{$ROUTE_MNM}' custom-folder='true'>See more at MNM<small>.team();</small></a>";
$_name_top = "[Mateus] <span class='text-primary'>byUwUr</span>";
$_nombre = "Andrés Trujillo Mateus";
$_new = "load not so basic HTML";
$_load = "<b>Loading standard view...</b><br>Still loading? <a href='/{$ROUTE_V1}' style='color:#0ae;'>Go to basic view</a>";
$_footer = "&copy;" . date("Y") . " Andrés Trujillo [Mateus] byUwUr<br><a href='/{$ROUTE_V1}'>load basic HTML</a> | <a href='/{$ROUTE_MNM}/{$ROUTE_COOKIES}'>cookie policy</a> | <a href='/{$ROUTE_MNM}'>MNM.team</a><br>Made with<i class='fas fa-heart'></i>by <a href='https://byuwur.co' target='_blank'>[Mateus] byUwUr</a>";
$_back = "Go back";
$_ok = "Understood";
$_close = "Close";
$_langs = "Languages";
