...
<head>
  ...
  <meta property="og:image" content="https://mnm.team/img/icon.png" />
              ...
              <div class="page-content">
                <div class="v-center-box d-flex align-items-center">
                  <div class="home-text">
                    ...
                    <div class="btn-bar">
                      <a href="resume.<?= $lang; ?>" target="_blank" class="btn btn-theme"><?= $_cv; ?></a>
                      <br><br><a href="ui-kit" target="_blank">UI kit preview</a>
                      <br><br><?= $_goto; ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="counter-row m-50px-t p-40px-t lg-m-35px-t lg-p-25px-t sm-p-15px-t">
                  <div class="row">
                    <div class="col-12 col-md-3 md-m-15px-tb">
                      ...
                      <br><a href="ui-kit" target="_blank">&& UI kit preview</a>
                    </div> <!-- col -->
                    <div class="col-12 col-md-4 md-m-15px-tb">
                      <h6>Digital Business Card v2</h6>
                      <iframe src="./card.v2.html" title="Digital Business Card v2" width="100%" height="100%" frameborder="0"></iframe>
                    </div> <!-- col -->
                    <div class="col-12 col-md-5 md-m-15px-tb">
                      <h6>Digital Business Card v1</h6>
                      <iframe src="./card.v1.html" title="Digital Business Card v1" width="100%" height="100%" frameborder="0"></iframe>
                    </div> <!-- col -->
                  </div> <!-- row -->
                </div>
              </div> <!-- page-content -->
