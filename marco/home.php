...
<head>
    ...
    <meta property="og:url" content="https://byuwur.net/marco/" />
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#about">
            ...
            <span class="d-none d-lg-block">
                <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="img/profile.jpg" alt="Marco" />
            </span>
        </a>
    ...
    <div class="container-fluid">
        ...
        <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
            <div class="my-auto">
                ...
                <div class="subheading" style="margin:10px;">
                    <a href="mailto:<?= $_mail; ?>"><?= $_mail; ?></a> | <a href="tel:<?= $_phone; ?>"><?= $_phone; ?></a>
                </div>
                <a href="#contact" class="a-logo nav-link js-scroll-trigger" style="font-size: 1.375em;"><?= $_start; ?></a><br>
            ...
            <div class="my-auto">
                ...
                <div class="resume-item d-flex flex-column flex-md-row mb-3">
                    <div class="resume-content mr-auto">
                        ...
                        <!-- p>GPA: N/A<font size="2">/5.0</font></p -->
                    </div>
                ...
                <div class="resume-item d-flex flex-column flex-md-row mb-3">
                    <div class="resume-content mr-auto">
                        ...
                        <!-- p>GPA: 4.2<font size="2">/5.0</font></p -->
                    </div>
                    <div class="resume-date text-md-right">
                ...
                <div class="resume-item d-flex flex-column flex-md-row mb-3">
                    <div class="resume-content mr-auto">
                        ...
                        <?= $_educationprog0; ?>
                        <!-- p>GPA: 4.0<font size="2">/5.0</font></p -->
                    </div>
                    <div class="resume-date text-md-right">
            ...
            <div class="my-auto">
                ...
                <div class="resume-item d-flex flex-column flex-md-row mb-5">
                    <div class="resume-content mr-auto">
                        ...
                        <div class="subheading mb-3"><?= $_experienceent0; ?> | <small><a href="https://soaint.com/" target="_blank">https://soaint.com/</a></small></div>
