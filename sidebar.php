...
<nav id="bywr-sidebar" class="bywr-sidebar accordion bywr-accordion bg-dark-transparent bg-blurred text-white">
  ...
  <div class="bywr-sidebar-content accordion-item flex-grow-1">
    <div class="bywr-sidebar-option p-2o5">
      <div class="navbar-brand has-background-contain" role="img" aria-label="<?= htmlspecialchars($LANG["sidebar.logo_alt"], ENT_QUOTES, "UTF-8") ?>"
  ...
  <a id="bywr-sidebar-toggle" class="bywr-sidebar-toggle" href="javascript:;" title="<?= htmlspecialchars($LANG["sidebar.toggle"], ENT_QUOTES, "UTF-8") ?>" aria-label="<?= htmlspecialchars($LANG["sidebar.toggle"], ENT_QUOTES, "UTF-8") ?>"
    data-bs-toggle="tooltip" data-bs-title="<?= htmlspecialchars($LANG["sidebar.toggle"], ENT_QUOTES, "UTF-8") ?>"><i class="fas fa-bars"></i><span><?= $LANG["sidebar.menu"] ?></span></a>
