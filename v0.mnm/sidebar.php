...
<div id="mnm-page">
    ...
    <aside id="mnm-aside" role="complementary">
        ...
        <nav id="mnm-main-menu" role="navigation">
            <ul>
                <li id="li_about"><a href="<?= "/{$ROUTE_MNM}" ?>"> <?= $_aboutus ?> </a></li>
                <li id="li_work"><a href="<?= "/{$ROUTE_MNM}/{$ROUTE_MNM_PROJECTS}" ?>"> <?= $_projects ?> </a></li>
                <li id="li_services"><a href="<?= "/{$ROUTE_MNM}/{$ROUTE_MNM_SERVICES}" ?>"> <?= $_services ?> </a></li>
                <li id="li_contact"><a href="<?= "/{$ROUTE_MNM}/{$ROUTE_MNM_CONTACT}" ?>"> <?= $_contactus ?> </a></li>
            </ul>
        </nav>
        <div class="mnm-footer">
            <p>&copy;<?= date("Y") ?>, MNM <br><small><small><a href="<?= "/" ?>">byUwUr</a> | <a href="https://colorlib.com" target="_blank">colorlib</a></small></small></p>
            <ul>
