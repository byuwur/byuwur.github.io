...
<nav id="bywr-sidebar" class="bywr-sidebar accordion bywr-accordion bg-dark-transparent bg-blurred text-white">
  ...
  <div class="bywr-sidebar-content accordion-item flex-grow-1">
    ...
    <a class="bywr-sidebar-option" href="#skills" title="<?= escape_html($LANG["nav.skills"], false) ?>" aria-label="<?= escape_html($LANG["nav.skills"], false) ?>">
      <i class="fas fa-screwdriver-wrench"></i><span><?= $LANG["nav.skills"] ?></span><i class="fas fa-angle-right ms-auto"></i>
    </a>
    <a class="bywr-sidebar-option" href="#experience" title="<?= escape_html($LANG["nav.experience"], false) ?>" aria-label="<?= escape_html($LANG["nav.experience"], false) ?>">
      <i class="fas fa-briefcase"></i><span><?= $LANG["nav.experience"] ?></span><i class="fas fa-angle-right ms-auto"></i>
    </a>
    <a class="bywr-sidebar-option" href="#education" title="<?= escape_html($LANG["nav.education"], false) ?>" aria-label="<?= escape_html($LANG["nav.education"], false) ?>">
      <i class="fas fa-graduation-cap"></i><span><?= $LANG["nav.education"] ?></span><i class="fas fa-angle-right ms-auto"></i>
    </a>
    <a class="bywr-sidebar-option" href="#awards" title="<?= escape_html($LANG["nav.portfolio"], false) ?>" aria-label="<?= escape_html($LANG["nav.portfolio"], false) ?>">
  ...
  <div class="bywr-sidebar-content accordion-item flex-grow-0">
    ...
    <div id="lang-drop" class="accordion-collapse collapse bg-dark-transparent" data-bs-parent="#bywr-sidebar">
      <div class="d-flex flex-row">
        <a class="bywr-sidebar-option" href="<?= "/{$ROUTE_V1}/{$ROUTE_ES}" ?>" title="<?= escape_html($LANG["language.spanish"], false) ?>"
          aria-label="<?= escape_html($LANG["language.spanish"], false) ?>">
        ...
        <a class="bywr-sidebar-option" href="<?= "/{$ROUTE_V1}/{$ROUTE_EN}" ?>" title="<?= escape_html($LANG["language.english"], false) ?>"
          aria-label="<?= escape_html($LANG["language.english"], false) ?>">
