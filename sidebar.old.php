...
<nav id="bywr-sidebar" class="bywr-sidebar accordion bywr-accordion bg-dark-transparent bg-blurred text-white">
  ...
  <div class="bywr-sidebar-content accordion-item flex-grow-1">
    ...
    <a class="bywr-sidebar-option" href="#about"
      title="<?= htmlspecialchars($LANG["nav.about"], ENT_QUOTES, "UTF-8") ?>"
      aria-label="<?= htmlspecialchars($LANG["nav.about"], ENT_QUOTES, "UTF-8") ?>">
    ...
    <a class="bywr-sidebar-option" href="#skills"
      title="<?= htmlspecialchars($LANG["nav.skills"], ENT_QUOTES, "UTF-8") ?>"
      aria-label="<?= htmlspecialchars($LANG["nav.skills"], ENT_QUOTES, "UTF-8") ?>">
      <i class="fas fa-screwdriver-wrench"></i><span><?= $LANG["nav.skills"] ?></span><i
        class="fas fa-angle-right ms-auto"></i>
    </a>
    <a class="bywr-sidebar-option" href="#experience"
      title="<?= htmlspecialchars($LANG["nav.experience"], ENT_QUOTES, "UTF-8") ?>"
      aria-label="<?= htmlspecialchars($LANG["nav.experience"], ENT_QUOTES, "UTF-8") ?>">
      <i class="fas fa-briefcase"></i><span><?= $LANG["nav.experience"] ?></span><i
        class="fas fa-angle-right ms-auto"></i>
    </a>
    <a class="bywr-sidebar-option" href="#education"
      title="<?= htmlspecialchars($LANG["nav.education"], ENT_QUOTES, "UTF-8") ?>"
      aria-label="<?= htmlspecialchars($LANG["nav.education"], ENT_QUOTES, "UTF-8") ?>">
      <i class="fas fa-graduation-cap"></i><span><?= $LANG["nav.education"] ?></span><i
        class="fas fa-angle-right ms-auto"></i>
    </a>
    <a class="bywr-sidebar-option" href="#awards"
      title="<?= htmlspecialchars($LANG["nav.portfolio"], ENT_QUOTES, "UTF-8") ?>"
      aria-label="<?= htmlspecialchars($LANG["nav.portfolio"], ENT_QUOTES, "UTF-8") ?>">
      <i class="fas fa-folder-tree"></i><span><?= $LANG["nav.portfolio"] ?></span><i
        class="fas fa-angle-right ms-auto"></i>
    </a>
    <a class="bywr-sidebar-option" href="#contact"
      title="<?= htmlspecialchars($LANG["nav.contact"], ENT_QUOTES, "UTF-8") ?>"
      aria-label="<?= htmlspecialchars($LANG["nav.contact"], ENT_QUOTES, "UTF-8") ?>">
  ...
  <div class="bywr-sidebar-content accordion-item flex-grow-0">
    ...
    <button class="accordion-header accordion-button p-2o5 collapsed" data-bs-toggle="collapse"
      ...
      aria-label="<?= htmlspecialchars($LANG["language.selector"], ENT_QUOTES, "UTF-8") ?>">
    ...
    <a class="bywr-sidebar-option" href="<?= "/" ?>"
      title="<?= htmlspecialchars($LANG["view.modern.title"], ENT_QUOTES, "UTF-8") ?>"
      aria-label="<?= htmlspecialchars($LANG["view.modern.title"], ENT_QUOTES, "UTF-8") ?>">
      <i class="fas fa-wand-magic-sparkles"></i><span><?= $LANG["view.modern.title"] ?></span><i
        class="fas fa-angle-right ms-auto"></i>
    </a>
